...
| 47        | `SamrQueryInformationUser2` | `Name`                 | `sAMAccountName`           | Unicode string           | ...              | Yes                   | ...          | The logon name of the user.                                                          |
...
| 13        | `SamrEnumerateUsersInDomain`| `Name`                 | `sAMAccountName`           | Unicode string (20 characters)| Yes         | Yes                   | Yes          | The logon name of the user.                                                          |
...
| 47        | `SamrQueryInformationUser2` | `ScriptPath`           | `scriptPath`               | Unicode string           | Yes              | Yes                   | Yes          | Path to the user’s login script, if any.                                             |
...
| 47        | `SamrQueryInformationUser2` | `UserAccountControl`   | `userAccountControl`       | Integer (32-bit)         | ...              | ...                   | ...          | Flags indicating user account properties, such as “disabled,” “password never expires.”|
| 47        | `SamrQueryInformationUser2` | `UserAccountType`      | Not explicitly defined     | Integer (32-bit)         | ...              | ...                   | ...          | Indicates whether the account is a normal user, administrator, or a service account. |
| 47        | `SamrQueryInformationUser2` | `LogonCount`           | `logonCount`               | Integer (32-bit)         | ...              | ...                   | ...          | The number of times the user has successfully logged on to the domain.               |
| 47        | `SamrQueryInformationUser2` | `BadPasswordCount`     | `badPwdCount`              | Integer (32-bit)         | ...              | ...                   | ...          | The number of failed password attempts.                                              |
| 47        | `SamrQueryInformationUser2` | `LogonHours`           | `logonHours`               | Bitmask                  | ...              | ...                   | ...          | A bitmask indicating the hours during which the user is allowed to log on.           |
